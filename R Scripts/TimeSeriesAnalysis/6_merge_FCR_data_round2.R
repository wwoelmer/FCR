...
# no put together chem and CTD data
...
## ctd and chem at site 50 and chem inflow successfully merged without losing data
...
join3 <- merge(join1, fluoro, by = c("Date", "Depth", "Site"), all = TRUE)
